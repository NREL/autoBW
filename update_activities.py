...
if __name__ == "__main__":
    ...
    for exchange in ACTIVITY.exchanges():
        if (
            exchange.get("input") == ("other_database", "1")
            and exchange.get("amount") == 10
            and exchange.get("unit") == "gallon"
            and exchange.get("type") == "production"
            and exchange.get("version") == 0
        ):
